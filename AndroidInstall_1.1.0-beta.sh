#!/bin/bash
#AndroidInstall_1.1.0-release.sh
#Nikolas A. Wagner © 2020

scriptName="AndroidInstall_1.1.0-beta"; scriptTitle="MONKEY INSTALLER"; author="Nikolas A. Wagner"
scriptVersion="1.1.0"; scriptVersionType="beta"; license="GNU GPLv3"
